...
./unpack.sh # Generated by packager
./skeleton/skeleton-unpack.sh # Unpack skeleton dependencies
source skeleton/skeleton.env # Init skeleton environment
which mvn
mvn -version
which java
java -version
...
"""
    ...
    def __init__(self, project_root, output_dir, include_modules=None, include_patterns=None, exclude_patterns=None):
    ...
    def package(self):
        ...
        self.packager.package_skeleton_dir()
